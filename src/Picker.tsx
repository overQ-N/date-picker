...
function InnerPicker<DateType>(props: PickerProps<DateType>) {
  ...
  const onInternalClick: React.MouseEventHandler<HTMLDivElement> = (
    ...args
  ) => {
    onClick?.(...args);
    ...
    >
      ...
      >
        <div
          ...
          className={classNames(
            "picker",
            "tw-inline-flex tw-shadow-light inner-border after:tw-border-gray-4 after:tw-rounded-lg focus-within:after:tw-border-2 focus-within:after:tw-border-theme-default tw-transition",
            prefixCls,
            className,
            {
